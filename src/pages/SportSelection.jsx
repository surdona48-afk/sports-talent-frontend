  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-extrabold text-white mb-2">Select Fitness Test</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Test 1: 10m Sprint */}
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-blue-500/50 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">10m Sprint</h2>
              <p className="text-slate-400 text-xs">Test 1 • Speed & Acceleration</p>
            </div>
          </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-emerald-500/50 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Vertical Jump</h2>
              <p className="text-slate-400 text-xs">Test 2 • Explosive Power</p>
            </div>
          </div>
          <p className="text-slate-400 text-sm mb-6">
