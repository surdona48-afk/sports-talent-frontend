  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 md:p-8 mb-8 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 text-center min-w-[200px]">
          <span className="block text-slate-500 text-xs uppercase font-semibold mb-1">Sprint Improvement</span>
          <span className="text-3xl font-extrabold text-emerald-400">+10.4%</span>
          <span className="block text-[10px] text-slate-400 mt-0.5">Compared to baseline test</span>
        </div>
      </div>

      {/* Graph Card Section */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 md:p-8 mb-8 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-white">Sprint Velocity Progression</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 text-center">
          ...
          <span className="text-3xl font-extrabold text-white">24.2 km/h</span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 text-center">
          ...
          <span className="text-3xl font-extrabold text-blue-400">94 / 100</span>
          <span className="text-slate-400 text-xs mt-2 block">Low variance across trials</span>
        </div>

        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 text-center">
          <span className="block text-slate-500 text-xs uppercase font-semibold mb-1">System Milestone</span>
          <span className="text-3xl font-extrabold text-emerald-400">MVP Ready</span>
      ...
      <div className="flex items-center justify-between bg-slate-900 border border-slate-800 p-5 rounded-2xl mb-8 shadow-xl">
        <div>
          <span className="text-slate-400 text-xs block mb-1">Latest Test Result</span>
          <h4 className="text-white font-bold text-lg">10m Sprint Assessment</h4>
        </div>
        <div className="text-right">
          ...
          <span className="block text-slate-400 text-xs font-semibold">Score: 91 / 100</span>
        </div>
      </div>
